import{r as v,u as C,j as b,c as w,x as u,w as c}from"./iframe-iBJb36Pk.js";import{m as k}from"./memoTheme-DtgnkE7u.js";import{g as x}from"./generateUtilityClass-BtcU_pBl.js";import{g as R}from"./generateUtilityClasses-DDbjFgb8.js";import{s as S,c as $}from"./styled-TlQKRrkf.js";function U(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function M(t){return parseFloat(t)}function A(t){return x("MuiSkeleton",t)}R("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const X=t=>{const{classes:e,variant:a,animation:n,hasChildren:o,width:i,height:s}=t;return $({root:["root",a,n,o&&"withChildren",o&&!i&&"fitContent",o&&!s&&"heightAuto"]},A,e)},r=c`
  0% {
    opacity: 1;
  }
