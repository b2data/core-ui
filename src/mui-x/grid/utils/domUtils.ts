...
export function findGridCellElementsFromCol(
  col: HTMLElement,
...
export function findGridElement(
  api: GridPrivateApiCommunity,
  klass: keyof typeof gridClasses,
) {
  return api.rootElementRef.current!.querySelector(
    `.${gridClasses[klass]}`,
  )! as HTMLElement;
}
