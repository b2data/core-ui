...
const isRowReorderingEnabledSelector = createSelector(
  ...
  (
    editRows,
    { rowReordering, treeData }: { rowReordering: boolean; treeData: boolean },
  ) => {
...
const GridRow = forwardRef<HTMLDivElement, GridRowProps>(
  function GridRow(props, refProp) {
    ...
    const isRowDragActive = useGridSelector(
      apiRef,
    ...
    const rightCells = pinnedColumns.right.map((column, i) => {
      const indexRelativeToAllColumns =
        visibleColumns.length - pinnedColumns.right.length + i;
      return getCell(
        column,
        i,
        indexRelativeToAllColumns,
