...
const GridVirtualScrollbar = forwardRef<
  HTMLDivElement,
  GridVirtualScrollbarProps
>(function GridVirtualScrollbar(props, ref) {
  ...
  const propertyScroll =
    props.position === "vertical" ? "scrollTop" : "scrollLeft";
  ...
  const contentSize =
    ...
    (hasScroll ? dimensions.scrollbarSize : 0);
  ...
  const Container =
    props.position === "vertical" ? ScrollbarVertical : ScrollbarHorizontal;
