...
export type QuickFilterProps = Omit<
...
> & {
   ...
   */
  formatter?: (
    values: NonNullable<GridFilterModel["quickFilterValues"]>,
  ) => string;
  /**
...
const DEFAULT_PARSER = (searchText: string) =>
...
function QuickFilter(props: QuickFilterProps) {
  ...
  React.useEffect(
    () => setQuickFilterValueDebounced.clear,
  ...
  return (
    <QuickFilterContext.Provider value={contextValue}>
      {element}
