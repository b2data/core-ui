...
const shouldShowBorderTopRightRadiusSelector = (
...
export const GridRootStyles = styled("div", {
  ...
  overridesResolver: (_props, styles) => [
    ...
    {
      [`&.${c["root--densityComfortable"]}`]:
        styles["root--densityComfortable"],
    },
    ...
    {
      [`& .${c["columnHeader--alignRight"]}`]:
        styles["columnHeader--alignRight"],
    },
    { [`& .${c["columnHeader--dragging"]}`]: styles["columnHeader--dragging"] },
    {
      [`& .${c["columnHeader--emptyGroup"]}`]:
        styles["columnHeader--emptyGroup"],
    },
    {
      [`& .${c["columnHeader--filledGroup"]}`]:
        styles["columnHeader--filledGroup"],
    },
    ...
    { [`& .${c["columnHeader--last"]}`]: styles["columnHeader--last"] },
    {
      [`& .${c["columnHeader--lastUnpinned"]}`]:
        styles["columnHeader--lastUnpinned"],
    },
    { [`& .${c["columnHeader--moving"]}`]: styles["columnHeader--moving"] },
    { [`& .${c["columnHeader--numeric"]}`]: styles["columnHeader--numeric"] },
    {
      [`& .${c["columnHeader--pinnedLeft"]}`]:
        styles["columnHeader--pinnedLeft"],
    },
    {
      [`& .${c["columnHeader--pinnedRight"]}`]:
        styles["columnHeader--pinnedRight"],
    },
    {
      [`& .${c["columnHeader--siblingFocused"]}`]:
        styles["columnHeader--siblingFocused"],
    },
    ...
    },
    {
      [`& .${c.columnHeaderTitleContainerContent}`]:
        styles.columnHeaderTitleContainerContent,
    },
    ...
    { [`& .${c.groupingCriteriaCell}`]: styles.groupingCriteriaCell },
    {
      [`& .${c.groupingCriteriaCellLoadingContainer}`]:
        styles.groupingCriteriaCellLoadingContainer,
    },
    {
    ...
    {
      [`& .${c["row--detailPanelExpanded"]}`]:
        styles["row--detailPanelExpanded"],
    },
    ...
    { [`& .${c.scrollbarFiller}`]: styles.scrollbarFiller },
    {
      [`& .${c["scrollbarFiller--borderBottom"]}`]:
        styles["scrollbarFiller--borderBottom"],
    },
    {
      [`& .${c["scrollbarFiller--borderTop"]}`]:
        styles["scrollbarFiller--borderTop"],
    },
    {
    ...
    },
    {
      [`& .${c["scrollbarFiller--pinnedRight"]}`]:
        styles["scrollbarFiller--pinnedRight"],
    },
