...
export const gridRowsStateSelector = createRootSelector(
  (state: GridStateCommunity) => state.rows,
);
...
export const gridRowTreeSelector = createSelector(
  gridRowsStateSelector,
  (rows) => rows.tree,
);
 ...
 * @ignore - do not document.
 */
export const gridPinnedRowsCountSelector = createSelector(
