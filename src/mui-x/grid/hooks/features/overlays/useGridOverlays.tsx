...
export const useGridOverlays = () => {
  ...
  if (loading) {
    ...
    loadingOverlayVariant =
      rootProps.slotProps?.loadingOverlay?.[
        noRows ? "noRowsVariant" : "variant"
  ...
  const getOverlay = () => {
    ...
    const Overlay =
      rootProps.slots?.[overlayType as NonNullable<GridOverlayType>];
    const overlayProps =
      rootProps.slotProps?.[overlayType as NonNullable<GridOverlayType>];
    return (
