...
import {
  GridColumnIndex,
  GridCellColSpanInfo,
} from "../../../models/gridColumnSpanning";
...
type ColSpanLookup = Record<
  GridRowId,
  Record<GridColumnIndex, GridCellColSpanInfo>
>;
 ...
 */
export const useGridColumnSpanning = (
  ...
  const calculateColSpan = React.useCallback<
    GridColumnSpanningPrivateApi["calculateColSpan"]
  >(
