...
const getVisibleRowsLookup: GridStrategyProcessor<
...
export const useGridFilter = (
  ...
  const updateFilteredRows = React.useCallback(() => {
    apiRef.current.setState((state) => {
      ...
      const visibleRowsLookupState = getVisibleRowsLookupState(
        apiRef,
        newState,
      );
  ...
  >(
    (items) => {
      ...
      apiRef.current.setFilterModel(
        { ...filterModel, items: existingItems },
        "upsertFilterItems",
      );
    },
    [apiRef],
  ...
  >(
    (params) => {
      if (
        ...
        (!params.filterModel.items.length &&
          !params.filterModel.quickFilterValues?.length)
      ) {
