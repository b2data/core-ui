...
interface ElementSlotProps {
  ...
  columnHeaderSortIcon: GridColumnHeaderSortIconProps &
  ...
  columnsManagement: GridColumnsManagementProps &
...
type Select<A, B, K> = K extends keyof A
  ? A[K]
  : K extends keyof B
    ? B[K]
    : never;
...
export type GridSlotProps = Merge<BaseSlotProps, MaterialSlotProps> &
  ElementSlotProps;
