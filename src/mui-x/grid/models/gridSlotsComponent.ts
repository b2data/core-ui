...
export interface GridBaseSlots {
   ...
   */
  baseAutocomplete: React.JSXElementConstructor<
    GridSlotProps["baseAutocomplete"]
  >;
  /**
   ...
   */
  baseCircularProgress: React.JSXElementConstructor<
    GridSlotProps["baseCircularProgress"]
  >;
  /**
   ...
   */
  baseLinearProgress: React.JSXElementConstructor<
    GridSlotProps["baseLinearProgress"]
  >;
  /**
  ...
  baseSelectOption: React.JSXElementConstructor<
    GridSlotProps["baseSelectOption"]
  >;
  /**
...
export interface GridSlotsComponent
  extends GridBaseSlots,
    GridIconSlotsComponent {
  /**
   * Component rendered for the bottom container.
   * @default GridBottomContainer
   */
  bottomContainer: React.JSXElementConstructor<
    GridSlotProps["bottomContainer"]
  >;
  /**
  ...
  columnHeaderSortIcon: React.JSXElementConstructor<
    GridSlotProps["columnHeaderSortIcon"]
  >;
  /**
   ...
   */
  noColumnsOverlay: React.JSXElementConstructor<
    GridSlotProps["noColumnsOverlay"]
  >;
  /**
