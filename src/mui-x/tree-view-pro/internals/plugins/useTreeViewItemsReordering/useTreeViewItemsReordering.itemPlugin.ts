...
export const useTreeViewItemsReorderingItemPlugin: TreeViewItemPlugin = ({
  props,
}) => {
  ...
  const validActionsRef =
    React.useRef<TreeViewItemItemReorderingValidActions | null>(null);
  ...
  const isValidTarget = useStore(
    store,
    itemsReorderingSelectors.isItemValidDropTarget,
    itemId,
  );
    ...
    propsEnhancers: {
      root: ({
        ...
        const handleDragStart = (
          event: React.DragEvent & TreeViewCancellableEvent,
        ) => {
      ...
      content: ({
        ...
        const handleDragEnter = (
          ...
          validActionsRef.current =
            instance.getDroppingTargetValidActions(itemId);
        };
