...
declare module "@mui/x-tree-view/useTreeItem" {
  interface UseTreeItemRootSlotOwnProps
    extends UseTreeItemRootSlotPropsFromItemsReordering {}

  interface UseTreeItemContentSlotOwnProps
    extends UseTreeItemContentSlotPropsFromItemsReordering {}
