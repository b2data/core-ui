...
export const PickersInputBaseSectionsContainer = styled(
  PickersSectionListRoot,
  {
    name: "MuiPickersInputBase",
    slot: "SectionsContainer",
    overridesResolver: (_props, styles) => styles.sectionsContainer,
  },
)<{ ownerState: PickerTextFieldOwnerState }>(({ theme }) => ({
  padding: "4px 0 5px",
...
const PickersInputBaseSectionContent = styled(
...
const PickersInputBaseSectionSeparator = styled(
...
const PickersInputBaseInput = styled("input", {
  name: "MuiPickersInputBase",
  slot: "Input",
  overridesResolver: (_props, styles) => styles.hiddenInput,
})({
  ...visuallyHidden,
});
...
const PickersInputBase = React.forwardRef(function PickersInputBase(
  ...
  const InputSectionsContainer =
    slots?.input || PickersInputBaseSectionsContainer;
