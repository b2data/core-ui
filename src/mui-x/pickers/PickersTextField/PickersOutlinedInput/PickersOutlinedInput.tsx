...
const PickersOutlinedInputSectionsContainer = styled(
  PickersInputBaseSectionsContainer,
  {
    name: "MuiPickersOutlinedInput",
...
const useUtilityClasses = (
  classes: Partial<PickersOutlinedInputClasses> | undefined,
) => {
  const slots = {
    root: ["root"],
  ...
  return (
    <PickersInputBase
      ...
      renderSuffix={(state) => (
        <Outline
          shrink={Boolean(
            notched || state.adornedStart || state.focused || state.filled,
          )}
          notched={Boolean(
            notched || state.adornedStart || state.focused || state.filled,
          )}
