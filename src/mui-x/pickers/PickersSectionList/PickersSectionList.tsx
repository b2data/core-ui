...
export const PickersSectionListSectionSeparator = styled("span", {
  ...
  overridesResolver: (_props, styles) => styles.sectionSeparator,
})({
  whiteSpace: "pre",
});
...
export const PickersSectionListSectionContent = styled("span", {
  name: "MuiPickersSectionList",
  slot: "SectionContent",
  overridesResolver: (_props, styles) => styles.sectionContent,
})({
  outline: "none",
});

const useUtilityClasses = (
  classes: Partial<PickersSectionListClasses> | undefined,
) => {
  const slots = {
    root: ["root"],
    section: ["section"],
...
interface PickersSectionProps
  extends Pick<PickersSectionListProps, "slots" | "slotProps"> {
...
function PickersSection(props: PickersSectionProps) {
  ...
  const SectionContent =
    slots?.sectionContent ?? PickersSectionListSectionContent;
  ...
  const SectionSeparator =
    slots?.sectionSeparator ?? PickersSectionListSectionSeparator;
  ...
  React.useImperativeHandle(sectionListRef, () => ({
    ...
    getSectionIndexFromDOMElement(element) {
      ...
      if (element.classList.contains(pickersSectionListClasses.section)) {
        ...
        element.classList.contains(pickersSectionListClasses.sectionContent)
      ) {
