...
export interface BaseDateTimePickerProps
  ...
  viewRenderers?: Partial<
    DateTimePickerViewRenderers<DateOrTimeViewWithMeridiem>
  >;
  /**
   * Available views.
   */
...
type UseDateTimePickerDefaultizedProps<Props extends BaseDateTimePickerProps> =
  LocalizedComponent<
    Omit<
      DefaultizedProps<
        Props,
        "openTo" | "orientation" | "ampm" | ValidateDateTimePropsToDefault
      >,
      "views"
    >
  > & {
...
export function useDateTimePickerDefaultizedProps<
  Props extends BaseDateTimePickerProps,
>(props: Props, name: string): UseDateTimePickerDefaultizedProps<Props> {
  ...
  const validationProps =
    useApplyDefaultValuesToDateTimeValidationProps(themeProps);
  ...
  const { openTo, views: defaultViews } =
    applyDefaultViewProps<DateOrTimeViewWithMeridiem>({
  ...
  const {
    ...
    thresholdToRenderTimeInASingleColumn:
      themeProps.thresholdToRenderTimeInASingleColumn,
    ampm,
