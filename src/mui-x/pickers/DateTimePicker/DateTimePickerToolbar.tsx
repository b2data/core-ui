...
const DateTimePickerToolbarDateContainer = styled("div", {
  name: "MuiDateTimePickerToolbar",
  slot: "DateContainer",
  overridesResolver: (_props, styles) => styles.dateContainer,
})<{ ownerState: PickerToolbarOwnerState }>({
  display: "flex",
...
const DateTimePickerToolbarTimeContainer = styled("div", {
  name: "MuiDateTimePickerToolbar",
  slot: "TimeContainer",
  overridesResolver: (_props, styles) => styles.timeContainer,
  shouldForwardProp: (prop) =>
    shouldForwardProp(prop) && prop !== "toolbarVariant",
})<{ ownerState: PickerToolbarOwnerState; toolbarVariant: PickerVariant }>({
  display: "flex",
...
const DateTimePickerToolbarTimeDigitsContainer = styled("div", {
  ...
  overridesResolver: (_props, styles) => styles.timeDigitsContainer,
  shouldForwardProp: (prop) =>
    shouldForwardProp(prop) && prop !== "toolbarVariant",
})<{ ownerState: PickerToolbarOwnerState; toolbarVariant: PickerVariant }>({
  display: "flex",
...
export const DateTimePickerToolbarOverrideContext = React.createContext<{
  ...
  setValue: (
    value: PickerValue,
    options?: SetValueActionOptions<DateTimeValidationError>,
  ) => void;
...
function DateTimePickerToolbar(inProps: DateTimePickerToolbarProps) {
  ...
  const { meridiemMode, handleMeridiemChange } = useMeridiemMode(
    value,
    ampm,
    (newValue) => setValue(newValue, { changeImportance: "set" }),
  );
  ...
  const toolbarTitle =
    inToolbarTitle ?? translations.dateTimePickerToolbarTitle;
          ...
          {views.includes("hours") && (
            <React.Fragment>
              ...
              <PickersToolbarButton
                ...
                selected={
                  view === "minutes" ||
                  (!views.includes("minutes") && view === "hours")
                }
