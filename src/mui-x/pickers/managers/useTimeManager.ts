  ...
  return React.useMemo(
    () => ({
      ...
      internal_useOpenPickerButtonAriaLabel:
        createUseOpenPickerButtonAriaLabel(ampm),
    }),
...
> {
  ...
  const validationProps =
    useApplyDefaultValuesToTimeValidationProps(internalProps);
  ...
  return React.useMemo(
    () => ({
      ...
      format:
        ...
        (ampm ? utils.formats.fullTime12h : utils.formats.fullTime24h),
    }),
...
export type UseTimeManagerReturnValue<
  TEnableAccessibleFieldDOMStructure extends boolean,
> = PickerManager<
  PickerValue,
