...
} from "./MultiSectionDigitalClock.utils";
import {
  PickerOwnerState,
  PickerValidDate,
  TimeStepOptions,
...
const useUtilityClasses = (
  classes: Partial<MultiSectionDigitalClockClasses> | undefined,
) => {
  const slots = {
    root: ["root"],
  };
 ...
 */
export const MultiSectionDigitalClock = React.forwardRef(
  function MultiSectionDigitalClock(
      ...
      (rawValue: number, viewType: TimeView) => {
        ...
        switch (viewType) {
          ...
          case "seconds": {
            ...
            return (
              !containsValidTime({ start, end }) || !isValidValue(rawValue)
            );
          }
              ...
              items: [
                {
                  ...
                  isFocused: () =>
                    !!valueOrReferenceDate && meridiemMode === "am",
                  ariaLabel: amLabel,
                },
                {
                  value: "pm",
                  ...
                  isFocused: () =>
                    !!valueOrReferenceDate && meridiemMode === "pm",
                  ariaLabel: pmLabel,
                },
              ],
            };
    ...
    const viewsToRender = React.useMemo(() => {
      ...
      const digitViews: TimeViewWithMeridiem[] = views.filter(
        (v) => v !== "meridiem",
      );
      digitViews.reverse();
    ...
    const viewTimeOptions = React.useMemo(() => {
      return views.reduce(
        ...
        {} as Record<
          ...
          MultiSectionDigitalClockViewProps<number>
        >,
      );
...
MultiSectionDigitalClock.propTypes = {
  ...
  views: PropTypes.arrayOf(
    PropTypes.oneOf(["hours", "meridiem", "minutes", "seconds"]).isRequired,
  ),
} as any;
