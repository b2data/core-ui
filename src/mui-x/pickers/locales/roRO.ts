...
const roROPickers: Partial<PickersLocaleText> = {
  ...
  openDatePickerDialogue: (formattedDate) =>
    formattedDate
      ? `Selectați data, data selectată este ${formattedDate}`
      : "Selectați data",
  openTimePickerDialogue: (formattedTime) =>
    formattedTime
      ? `Selectați ora, ora selectată este ${formattedTime}`
      : "Selectați ora",
  ...
  fieldMonthPlaceholder: (params) =>
    params.contentType === "letter" ? "LLLL" : "LL",
  fieldDayPlaceholder: () => "ZZ",
  fieldWeekDayPlaceholder: (params) =>
    params.contentType === "letter" ? "ZZZZ" : "ZZ",
