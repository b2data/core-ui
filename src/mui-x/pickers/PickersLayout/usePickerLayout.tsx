...
): toolbarProps is BaseToolbarProps {
...
interface UsePickerLayoutResponse<TValue extends PickerValidValue>
...
const usePickerLayout = <TValue extends PickerValidValue>(
  ...
  const tabs =
    view && Tabs ? (
      <Tabs className={classes.tabs} {...slotProps?.tabs} />
    ) : null;
  ...
  const shortcuts =
    view && !!Shortcuts ? <Shortcuts {...shortcutsProps} /> : null;
