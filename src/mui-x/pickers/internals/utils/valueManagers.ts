...
export const singleItemValueManager: SingleItemPickerValueManager = {
  ...
  getTimezone: (utils, value) =>
    utils.isValid(value) ? utils.getTimezone(value) : null,
...
export const singleItemFieldValueManager: FieldValueManager<PickerValue> = {
  ...
  getSectionsFromValue: (date, getSectionsFromDate) =>
  ...
  updateDateInValue: (_value, _activeSection, activeDate) => activeDate,
