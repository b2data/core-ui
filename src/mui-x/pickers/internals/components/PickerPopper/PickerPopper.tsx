...
export interface PickerPopperSlotProps {
   ...
   */
  desktopPaper?: SlotComponentPropsFromProps<
    PaperProps,
    {},
...
const useUtilityClasses = (
  classes: Partial<PickerPopperClasses> | undefined,
) => {
  const slots = {
    root: ["root"],
    paper: ["paper"],
...
export function PickerPopper(inProps: PickerPopperProps) {
  ...
  const Transition =
    (slots?.desktopTransition ?? reduceAnimations) ? Fade : Grow;
