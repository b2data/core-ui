...
} from "../hooks/useToolbarOwnerState";

export interface PickersToolbarProps
  extends Pick<BaseToolbarProps, "hidden" | "titleId"> {
  className?: string;
...
const PickersToolbarContent = styled("div", {
  ...
  shouldForwardProp: (prop) =>
    shouldForwardProp(prop) && prop !== "landscapeDirection",
})<{
...
type PickersToolbarComponent = ((
  props: React.PropsWithChildren<PickersToolbarProps> &
