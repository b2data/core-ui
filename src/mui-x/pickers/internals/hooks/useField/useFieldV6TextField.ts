...
>(
  ...
  const handleInputPaste = useEventCallback(
        ...
        const selectionStart =
          selectedSection.type === "empty"
            ? selectedSection.startInInput -
              selectedSection.startSeparator.length
            : selectedSection.startInInput;
        const selectionEnd =
          selectedSection.type === "empty"
...
type FieldSectionWithPositions<TValue extends PickerValidValue> =
