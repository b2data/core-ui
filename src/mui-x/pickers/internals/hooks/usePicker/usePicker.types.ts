...
> extends OnErrorProps<TValue, TError>,
    Omit<
      ...
      "onChange" | "onFocusedViewChange" | "focusedView"
    >,
    TimezoneProps,
    FormProps {
  /**
 ...
 */
export interface UsePickerNonStaticProps
  extends Omit<PickerFieldPrivateContextValue, "fieldRef"> {
  /**
...
export type PickerViewRenderer<
  ...
  TExternalProps extends PickerViewsRendererBaseExternalProps,
> = (
  props: PickerViewsRendererProps<TValue, any, TExternalProps>,
) => React.ReactNode;
