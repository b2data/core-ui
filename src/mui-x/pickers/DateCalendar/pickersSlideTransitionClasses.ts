...
export type PickersSlideTransitionClassKey =
  keyof PickersSlideTransitionClasses;

export const getPickersSlideTransitionUtilityClass = (slot: string) =>
  generateUtilityClass("MuiPickersSlideTransition", slot);

export const pickersSlideTransitionClasses: PickersSlideTransitionClasses =
  generateUtilityClasses("MuiPickersSlideTransition", [
    "root",
    "slideEnter-left",
    "slideEnter-right",
    "slideEnterActive",
