...
export type GridPivotingPropsOverrides = {
  ...
  rowGroupingModel: NonNullable<
    DataGridPremiumProcessedProps["rowGroupingModel"]
  >;
  aggregationModel: NonNullable<
    DataGridPremiumProcessedProps["aggregationModel"]
  >;
  getAggregationPosition: NonNullable<
    DataGridPremiumProcessedProps["getAggregationPosition"]
  >;
  columnVisibilityModel: NonNullable<
    DataGridPremiumProcessedProps["columnVisibilityModel"]
  >;
  columnGroupingModel: NonNullable<
    DataGridPremiumProcessedProps["columnGroupingModel"]
  >;
  ...
  disableAggregation: NonNullable<
    DataGridPremiumProcessedProps["disableAggregation"]
  >;
  disableRowGrouping: NonNullable<
    DataGridPremiumProcessedProps["disableRowGrouping"]
  >;
};
...
export interface GridPivotingApi {
   ...
   */
  setPivotModel: (
    model: GridPivotModel | ((prev: GridPivotModel) => GridPivotModel),
  ) => void;
  /**
...
export interface GridPivotingPrivateApi
  extends GridPivotingPrivateApiCommunity {
