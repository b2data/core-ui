...
export interface GridDataSourcePremium extends Omit<GridDataSource, "getRows"> {
  ...
  ): Promise<GridGetRowsResponsePremium>;
  /**
...
export interface GridDataSourceApiBasePremium
  extends Omit<GridDataSourceApiBase, "fetchRows"> {
  /**
  ...
  fetchRows: (
    parentId?: GridRowId,
    params?: Partial<GridGetRowsParamsPremium>,
  ) => void;
}
...
export interface GridDataSourcePremiumPrivateApi
  extends GridDataSourcePrivateApi {
