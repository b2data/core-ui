...
const validationRules: ValidationRule[] = [
...

  {
    ...
    applies: (ctx) =>
      conditions.isGroupToGroup(ctx) && conditions.isDropBelow(ctx),
    isInvalid: (ctx) => {
  ...
  // ===== Leaf to Leaf Rules =====
  {
    ...
    applies: (ctx) =>
      conditions.isLeafToLeaf(ctx) && !conditions.sameDepth(ctx),
    isInvalid: () => true,
  ...
  // ===== Leaf to Group Rules =====
  {
    ...
    applies: (ctx) =>
      conditions.isLeafToGroup(ctx) && conditions.isDropAbove(ctx),
    isInvalid: (ctx) =>
      !conditions.hasPrevNode(ctx) || !conditions.prevIsLeaf(ctx),
...

  {
    ...
    applies: (ctx) =>
      conditions.isLeafToGroup(ctx) && conditions.isDropBelow(ctx),
