 ...
 */
const PromptField = forwardRef<HTMLDivElement, PromptFieldProps>(
  function PromptField(props, ref) {
    const { render, className, lang, onRecordError, onSubmit, ...other } =
      props;
    ...
    return (
      <PromptFieldContext.Provider value={contextValue}>
        {element}
