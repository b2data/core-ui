...
const GridPivotPanelFieldRoot = styled("div", {
  ...
  overridesResolver: (_props, styles) => [
    {
      [`&.${gridClasses["pivotPanelField--sorted"]}`]:
        styles["pivotPanelField--sorted"],
    },
  ...
  variants: [
    {
      ...
      style: { borderTopColor: vars.colors.interactive.selected },
    },
    {
...
const GridPivotPanelFieldCheckbox = styled(
