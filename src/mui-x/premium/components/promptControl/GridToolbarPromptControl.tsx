...
const useUtilityClasses = (ownerState: OwnerState) => {
  ...
  const slots = {
    root: [
      ...
      recording && "toolbarPromptControl--recording",
    ],
  ...
  const processPrompt = React.useCallback(() => {
    ...
    onPrompt(context, query)
      .then((result) => {
        ...
        const targetIndex =
          Number(
            columns.find((c) => c.field === GRID_CHECKBOX_SELECTION_FIELD) !==
              undefined,
      ...
      .catch((_) => {
        setError(
          apiRef.current.getLocaleText("toolbarPromptControlErrorMessage"),
        );
      })
      .finally(() => {
        setLoading(false);
    ...
    >
      <rootProps.slots.baseTextField
        placeholder={
          isRecording
            ? apiRef.current.getLocaleText(
                "toolbarPromptControlRecordingPlaceholder",
              )
            : placeholder
        }
            ...
            endAdornment: (
              <rootProps.slots.baseTooltip
                title={apiRef.current.getLocaleText(
                  "toolbarPromptControlSendActionLabel",
                )}
              >
                <div>
