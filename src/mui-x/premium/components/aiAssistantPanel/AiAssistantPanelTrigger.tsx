...
export type AiAssistantPanelTriggerProps = Omit<
 ...
 */
const AiAssistantPanelTrigger = forwardRef<
  HTMLButtonElement,
...
>(function AiAssistantPanelTrigger(props, ref) {
  ...
  const open =
    panelState.open &&
    panelState.openedPanelValue === GridPreferencePanelsValue.aiAssistant;
  const state = { open };
  ...
  const handleClick = (event: React.MouseEvent<HTMLButtonElement>) => {
    if (open) {
      ...
      apiRef.current.showPreferences(
        GridPreferencePanelsValue.aiAssistant,
        panelId,
        buttonId,
      );
    }
