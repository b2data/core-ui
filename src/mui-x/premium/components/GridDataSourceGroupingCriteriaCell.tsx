...
function GridGroupingCriteriaCellIcon(
  props: GridGroupingCriteriaCellIconProps,
) {
...
export function GridDataSourceGroupingCriteriaCell(
  props: GridGroupingCriteriaCellProps,
) {
