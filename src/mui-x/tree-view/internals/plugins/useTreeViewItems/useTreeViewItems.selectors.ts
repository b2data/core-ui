...
export const itemsSelectors = {
  ...
  error: createSelector(
    (state: TreeViewState<[UseTreeViewItemsSignature]>) => state.items.error,
  ),
  /**
  ...
  disabledItemFocusable: createSelector(
    (state: TreeViewState<[UseTreeViewItemsSignature]>) =>
      state.items.disabledItemsFocusable,
  ),
  /**
  ...
  itemOrderedChildrenIds: createSelector(
    (
      ...
      state.items.itemOrderedChildrenIdsLookup[
  ...
  itemIndex: createSelector(
    (
      ...
      const parentIndexes =
        state.items.itemChildrenIndexesLookup[
