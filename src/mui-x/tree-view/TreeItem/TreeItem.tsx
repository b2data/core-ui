...
export const TreeItemGroupTransition = styled(Collapse, {
  ...
  overridesResolver: (_props, styles) => styles.groupTransition,
})({
  margin: 0,
  padding: 0,
});
...
export const TreeItemCheckbox = styled(
  React.forwardRef(
    (
      props: CheckboxProps & { visible?: boolean },
...
const useUtilityClasses = (
  classesProp: Partial<TreeItemClasses> | undefined,
) => {
...
export const TreeItem = React.forwardRef(function TreeItem(
  ...
  const IconContainer: React.ElementType =
    slots.iconContainer ?? TreeItemIconContainer;
  ...
  const GroupTransition: React.ElementType | undefined =
    slots.groupTransition ?? undefined;
  ...
  const ErrorIcon: React.ElementType =
    slots.errorIcon ?? TreeItemErrorContainer;
  ...
  const LoadingIcon: React.ElementType =
    slots.loadingIcon ?? TreeItemLoadingContainer;
