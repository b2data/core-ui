...
export const Actions: React.FC<{
  ...
  const { state, dispatch } = React.useContext(DataBlockEditorContext);
  ...
  const handleEdit = (
    offset: number,
    changes: Partial<DataBlockVariant["data"]>,
  ) => {
    dispatch({
      action: DataBlockEditorAction.EditBlock,
      block: { ...blockData, offset },
      variant: {
        ...currentVariant,
        data: { ...currentVariant.data, ...changes },
      },
    });
    setMenuAnchorEl(null);
  };
