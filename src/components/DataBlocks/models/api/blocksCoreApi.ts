...
import {
  BlocksEventListener,
  BlocksEventPublisher,
  BlocksEvents,
} from "../events";
import { Store } from "../../utils";

/**
 * The core API interface that is available in the `apiRef`.
 */
export interface BlockCoreApi {
  /**
   ...
   */
  subscribeEvent: <E extends BlocksEvents>(
    event: E,
    handler: BlocksEventListener<E>,
   ...
   */
  publishEvent: BlocksEventPublisher;
  /**
